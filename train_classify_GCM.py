    ...
    for epoch in range(starting_epoch, config.trainer.num_epochs):
        ...
        if val_top > best_top_1:
            ...
            if config.GCM_loader.fusion == False:
                ...
                best_test_top_1 = final_metrics["Val/accuracy"]
                best_test_metrics = final_metrics

        accelerator.print(
            f'Epoch [{epoch+1}/{config.trainer.num_epochs}] now train acc: {train_metric["Train/accuracy"]}, now val acc: {val_top}, best acc: {best_top_1}, best test acc: {best_test_top_1}'
        )
        ...
        torch.save(
            {
                ...
                "best_test_top_1": best_test_top_1,
